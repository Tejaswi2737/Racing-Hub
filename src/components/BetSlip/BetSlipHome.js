...
//             if(finalRemainingBets.length>=1) {
...
//             users = [...localRemaining];
//             setgetLocal(false)
//         } else {users=[users,...props.remainingBetSlip]}
...
//         // if (RemainingBets.length==1 || RemainingBets===[]){
//         //     setstartSlip(false)
//         //     setRemainingBets([])
//         // }
